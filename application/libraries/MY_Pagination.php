...
class MY_Pagination extends CI_Pagination {
	...
	var $num_pages 		= 0; 	// The total number of pages
	 ...
	 * @return	string
	 */
	function create_links( $style = "default" )
	{
		// Cargo las variables de configuración segun el estilo definido 
		$this->style_links( $style );
